...
const Checkout = (props) => {
    ...
    const schema = yup.object().shape({
        ...
        amountPeople:
            yup
                .number("Vui lòng nhập số người").min(1).max(4),
    });
                                            ...
                                            <div className="col-md-12 my-3">
                                                <div className="row justify-content-between align-items-center">
                                                    <div className="col-md-7 border-bottom rounded">
                                                        <input type="number" {...register("amountPeople")} className="form-control border-none" name="people" id="people" placeholder="Enter amount people" />
                                                        {errors.amountPeople?.message && <p className="text-danger">{errors.amountPeople.message}</p>}
                                                    </div>
