                ...
                <div className='col-md-6 card mx-1'>
                    <div className='row'>
                        ...
                        <div className='d-flex justify-content-between'>
                            <div className={`opacity-25 card align-items-center method ${Paymentmethods.card ? 'selected' : ''} `} onClick={()=>alert("Method in progress unable to used")}>
                            ...
                            <div className={`opacity-25 card align-items-center method ${Paymentmethods.paypal ? 'selected' : ''} `} onClick={() => handleChangeMethod('paypal')}>
                                <div className='card-body'>
                            ...
                            <div className={`opacity-25 card align-items-center method ${Paymentmethods.momo ? 'selected' : ''} `} onClick={() => handleChangeMethod('momo')}>
                                <div className='card-body'>
                            ...
                            <div className={`opacity-25 card align-items-center method ${Paymentmethods.vnpay ? 'selected' : ''} `} onClick={() => handleChangeMethod('vnpay')}>
                                <div className='card-body'>
