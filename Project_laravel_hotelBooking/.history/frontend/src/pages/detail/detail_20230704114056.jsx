...
function Detail() {
  ...
  useEffect(() => {
    ...
    // }
    console.log("One Room and images:", data)
    console.log("One Room and data services:", data.services)
  }, [data]);
      ...
      <div className="container-fluid">
        ...
        <div className="row">
          <div className="col-lg-8 col-sm-12">
            <div className="col-sm-12">
              ...
              >
                ...
                <img src={'https://us.123rf.com/450wm/jezepidesigns/jezepidesigns1707/jezepidesigns170700108/94046574-fleurs-d.jpg?ver=6'} alt="anh" />
                <img src={'https://st2.depositphotos.com/1993283/8077/i/450/depositphotos_80770388-stock-photo-spring-chamomile-background.jpg'} alt="anh" />
          ...
          <div className="col-md-4 col-sm-12">
            <div className="d-inline-sm-flex">
              <Checkout id={id} services = {data ? data.services :null} />
            </div>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-md-4 my-3">
            ...
            <Services data={data ? data.services : null} />
          </div>
