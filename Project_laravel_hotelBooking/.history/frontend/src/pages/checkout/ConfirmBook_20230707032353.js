                ...
                <div className='col-md-6 card mx-1'>
                    <div className='row'>
                        ...
                        <div className='d-flex justify-content-between'>
                            <div className={`card align-items-center method ${Paymentmethods.card ? 'selected' : ''} `} onClick={() => handleChangeMethod('card')}>
                            ...
                            <div className={`card align-items-center method ${Paymentmethods.card ? 'selected' : ''} `} onClick={() => handleChangeMethod('paypal')}>
                                <div className='card-body'>
                            ...
                            <div className={`card align-items-center method ${Paymentmethods.card ? 'selected' : ''} `} onClick={() => handleChangeMethod('momo')}>
                                <div className='card-body'>
                            ...
                            <div className={`card align-items-center method ${Paymentmethods.card ? 'selected' : ''} `} onClick={() => handleChangeMethod('vnpay')}>
                                <div className='card-body'>
                            ...
                            <div className={`card align-items-center method ${Paymentmethods.card ? 'selected' : ''} `} onClick={() => handleChangeMethod('cash')}>
                                <div className='card-body'>
