...
function ConfirmBook() {
    ...
    const handleChangeMethod = (data) => {
        switch (data) {
            case 'card': setPaymentMethod(prevPaymentMethod => ({
                ...prevPaymentMethod,
                card: true,
                momo: false,
                paypal: false,
                ...
                break;
            case 'momo': setPaymentMethod(prevPaymentMethod => ({
                ...prevPaymentMethod,
                card: false,
                momo: true,
                paypal: false,
                ...
                break;
            case 'paypal': setPaymentMethod(prevPaymentMethod => ({
                ...prevPaymentMethod,
                card: false,
                momo: false,
                paypal: true,
                ...
                break;
            case 'vnpay': setPaymentMethod(prevPaymentMethod => ({
                ...prevPaymentMethod,
                card: false,
                momo: false,
                paypal: false,
                ...
                break;
            case 'cash': setPaymentMethod(prevPaymentMethod => ({
                ...prevPaymentMethod,
                card: false,
                momo: false,
                paypal: false,
                                ...
                                <p className='row'>
                                    {/* lấy services đã chọn bỏ vào đây */}
                                    {
                                        services && services.length ?
                                            services.map(
                                                service => (<div className='col-12 text-secondary'> {service.name} __ {fortmatMoneyservice.price}$</div>)
                                            )
