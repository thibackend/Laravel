...
function ConfirmBook() {
    ...
    return (
        <div className='container'>
            ...
            <div className='d-flex justify-content-s flex-sm-dicoration-column rounded shadow'>
                <h5 className='black-border mx-3'>Cards</h5>
                <h5 className='black-border mx-3'>PayPal</h5>
                <h5 className='black-border mx-3'>Momo</h5>
                <h5 className='black-border mx-3'>VnPay</h5>
            </div>
            <div className='card'>
