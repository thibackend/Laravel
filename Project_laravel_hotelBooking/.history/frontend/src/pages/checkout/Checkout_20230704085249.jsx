                                                ...
                                                <div className="row align-items-center">
                                                    <div className="col-md-6 border-bottom rounded">
                                                        <label htmlFor="credit">
                                                            <input type="radio" name="cCredit" id="credit" placeholder="Enter amount people" />
                                                            credit card
                                                        </label>
                                                    </div>
                                                    <div className="col-md-6 border-bottom rounded">
                                                    ...
                                                    <div className="row">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control" name="credit" id="credit" placeholder="Enter creadit card number" />
                                                        </div>
                                                    </div>
