                                        ...
                                        <div className="col-md-12 black-border">
                                            ...
                                            <div className="col-md-12">
                                                <div className="row justify-content-between align-items-center">
                                                    <div className="col-md-6">
                                                        <input type="number" className="form-control border-bottom rounded" name="people" id="people" placeholder="Enter amount people" />
                                                    </div>
                                                    <div className="col-md-6 border-bottom rounded form-control">
                                                        <h6 className="border-bottom rounded form-control">total: 3000$</h6>
                                                    </div>
                                                </div>
