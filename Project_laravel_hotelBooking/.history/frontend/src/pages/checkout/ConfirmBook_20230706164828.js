        ...
        <div className='container'>
            <div className='row d-flex justify-content-between aligin-items-center my-2 p-2'>
                <div className='col-md-7 black-border card'>
                    ...
                    <div className='card-footer d-inline-flex justify-content-start'>
                        <button className='danger-border'> Close</button>
                        <button className='danger-border'> Confirm</button>
                    </div>
                </div>

                {/* ben này dùng để lưu các thông tin của dặt phòng*/}
                <div className='col-md-4 card inline'>
