                                ...
                                <div className="col-md-12 black-border">
                                    ...
                                    <div className="row justify-content-center">
                                        <div className="col-md-12 black-border">
                                            ...
                                            {/* show so luong nguoi */}
                                            <div className="col-md-6 black-border">
                                                <label htmlFor="people">
                                                    <input type="number" className="form-control" name="people" id="people" placeholder="Enter amount people" />
                                                </label>
                                            </div>
                                            <div className="col-md-6 black-border rounded">
                                                <label htmlFor="people">
                                                    <input type="number" className="form-control" name="people" id="people" placeholder="Enter amount people" />
                                                </label>
                                            </div>
