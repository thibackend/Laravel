              ...
              >
                {
                  images ?
                    images.map((e, index) =>
                    (
                      <img key={index} src={`http://127.0.0.1:8000/uploads/images/${e}`} alt='Anh tượng trung' style={{ width: '100px', height: '100px' }} />
                    )
                    )
                    :
                    <img src={'https://cdn.pixabay.com/photo/2015/04/19/08/32/marguerite-729510_1280.jpg'} alt="anh" style={{ width: '100px', height: '100px' }} />
                }
              </Slider>
