                        ...
                        <div className="card-body">
                            <div className="row">
                                <div className="col-md-12">
                                    ...
                                    <div className="row justify-content-center shadow rounded">
                                        <div className="col-md-12">
                                            {/* show services */}
                                                ...
                                                <div className="row align-items-center">
                                                    <div className="col-md-6 border-bottom rounded">
                                                        <label htmlFor="credit">
                                                            <input type="radio" value={true} name="checkCredit" id="credit" placeholder="Enter amount people" onChange={handleCreditCardChange} />
                                                            the tin dung
                                                        </label>
                                                    </div>
                                                    <div className="col-md-6 border-bottom rounded">
                                                        <label htmlFor="credit">
                                                            <input type="radio" name="checkCredit" id="credit" value={false} placeholder="Enter amount people" />
                                                            tien mat
                                                        </label>
                                                    </div>
                                                    {
                                                        credit &&
                                                        <div className="row my-2 shadow round">
                                                            <div class="form-group">
                                                                <label for="credit">Your credit card</label>
                                                                <input type="number" class="form-control" name="credit" id="credit" placeholder=" Card number" />
                                                            </div>
                                                        </div>
                                                    }
                                                </div>
