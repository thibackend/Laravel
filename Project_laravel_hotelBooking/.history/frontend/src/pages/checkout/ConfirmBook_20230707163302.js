...
function ConfirmBook() {
    ...
    const [meto, setpaymentMethod] = useState();
    ...
    const setMethod = () => {
        if (dataBook.cash) { return setpaymentMethod("Cash"); }
        if (dataBook.card) { return setpaymentMethod("Card") }
        if (dataBook.vnpay) { return setpaymentMethod("VnPay"); }
        if (dataBook.paypal) { return setpaymentMethod("PayPal"); }
        if (dataBook.momo) { return setpaymentMethod("MoMo"); }
    }
