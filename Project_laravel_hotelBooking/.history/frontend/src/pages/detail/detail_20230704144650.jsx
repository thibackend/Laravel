...
function Detail() {
  ...
  useEffect(() => {
    ...
    if (data && data.img_path && !images) {
       console.log("image data has set :",data.img_path)
       setImage(data.img_path)
    }

    if (data && !roomRelevant) {
      fetchAllRoom();
    }
    console.log("get one room :", data)
          ...
          >
            ...
            <div className="col-md-3">
              <Card style={{ width: '20rem' }}>
                <Card.Img variant="top" src="holder.js/100px180" />
                <Card.Body>
                  <Card.Title>Name room</Card.Title>
                  <Card.Text>
                    Some quick example text to build on the card title and make up the
                    bulk of the card's content.
                  </Card.Text>
