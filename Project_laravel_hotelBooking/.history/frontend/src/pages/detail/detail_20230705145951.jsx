      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-lg-8 col-sm-12">
            <div className="col-sm-12" style={{width:'200px' , height:'200px'}}>
              <Slider
                dots={true}
                infinite={true}
                speed={500}
              ...
              >
                {
                  images ?
                    images.map((e, index) =>
                    (
                      <img key={index} src={`http://127.0.0.1:8000/uploads/images/${e}`} alt='Anh tượng trung' style={{width:'500px',height:'500px'}}/>
                    )
                    )
                    :
