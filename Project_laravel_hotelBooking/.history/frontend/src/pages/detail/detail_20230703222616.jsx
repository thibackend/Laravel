            ...
            <swiper-container // vì là một component của một thư viện khác nên sẽ có tên className riêng của nó.  .swiper-backface-hidden swiper-slide
              ...
              <swiper-slide className='slide-item'>
                ...
                <div className="slide-caption">
                  <h3>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Commodi magnam ut placeat dolor eum totam, facilis quis illum esse itaque amet autem iure, architecto odio. Quia doloremque dolore nisi perferendis.</h3>
                </div>
              </swiper-slide>
            </swiper-container>
          </div>
