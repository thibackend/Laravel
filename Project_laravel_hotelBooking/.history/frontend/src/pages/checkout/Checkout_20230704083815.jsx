                                        ...
                                        <div className="col-md-12 black-border">
                                                ...
                                                <div className="row align-items-center">
                                                    <div className="col-md-6 border-bottom rounded">
                                                        <label htmlFor="credit">
                                                            <input type="radio" name="credit" id="credit" placeholder="Enter amount people" />
                                                            credit card
                                                        </label>
                                                    </div>
                                                    <div className="col-md-6 border-bottom rounded">
                                                        <label htmlFor="tienmat">
                                                            <input type="radio" name="tienmat" id="tienmat" placeholder="Enter amount people" />
                                                            tien mat
                                                        </label>
                                                    </div>

                                                    <div className="col-md-12 border-bottom rounded">
                                                        <label htmlFor="credit">
                                                            <input type="input"  name="people" id="people" placeholder="Enter amount people" />
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-md-12">
                                                <div className="row justify-content-between align-items-center">
                                                    <div className="col-md-6 border-bottom rounded">
                                                        <input type="checkbox" name="people" id="people" placeholder="Enter amount people" max={3} />
                                                    </div>
                                                    <div className="col-md-6 border-bottom rounded">
                                                        <h6 >total: 3000$</h6>
                                                    </div>
