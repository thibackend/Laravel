...
function ConfirmBook() {
    ...
    const setMethod = () => {
        if (dataBook.cash){setpaymentMethod("Cash"); return;} 
        if (dataBook.card){setpaymentMethod("Card"); return;} 
        if (dataBook.vnpay){setpaymentMethod("VnPay"); return;} 
        if (dataBook.paypal){setpaymentMethod("PayPal"); return;} 
        if (dataBook.momo){setpaymentMethod("PayPal"); return;} 
    }
