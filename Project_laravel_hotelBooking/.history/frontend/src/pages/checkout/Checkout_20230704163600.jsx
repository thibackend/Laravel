...
const Checkout = (props) => {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            daycheckin: Yup.date().required('Vui lòng nhập ngày check-in.'),
            daycheckout: Yup.date()
                .min(Yup.ref('daycheckin'), 'Ngày check-out phải sau ngày check-in.')
                                    ...
                                    <div className="row">
                                        <div className="col-md-6">
                                            <div className="form-group mb-3">
                                                ...
                                                {formik.touched.daycheckin && formik.errors.daycheckin && (
                                                    <div>{formik.errors.daycheckin}</div>
                                                )}
                                            </div>
                                        </div>
                                        <div className="col-md-6">
