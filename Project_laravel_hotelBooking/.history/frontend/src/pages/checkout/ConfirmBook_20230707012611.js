...
function ConfirmBook() {
    ...
    const handleChangeMethod = (data) => {
        ...
        switch (data) {
            case 'card': alert('tien mat')

                break;
            case 'momo': alert('tien mat')

                break;
            case 'paypal':alert('tien mat')
                    ...
                    <div className='row'>
                        ...
                        <div className='d-flex justify-content-between'>
                            ...
                            <div className='card align-items-center'>
                                ...
                                <p className='card-text' onClick={() => handleChangeMethod('momo')}>
                                    Momo
                                </p>
                            </div>
                            ...
                            <div className='card align-items-center'>
                                ...
                                <p className='card-text' onClick={() => handleChangeMethod('tiemmat')}>
                                    Tiền mặt
                                </p>
                            </div>
                        </div>
