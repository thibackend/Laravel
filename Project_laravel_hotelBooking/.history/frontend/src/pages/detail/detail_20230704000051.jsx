            ...
            <div className="col-sm-12">
              ...
              <div className="d-text">
                <div className="d-sm-flex flex-row justify-content-start">
                  <div className="black-border">5.0</div>
                  <div className="black-border">Perfect</div>
                  <div className="black-border">Top Value</div>
                  <div className="d-flex flex-row align-contens-center">
                  <StarIcon />
                  <StarIcon />
                  <StarIcon />
                  <StarIcon />
