                ...
                <div className='col-md-6 card mx-1'>
                    <div className='row'>
                        ...
                        <div className='d-flex justify-content-between'>
                            <div className={`opacity-25 card align-items-center method ${Paymentmethods.card ? 'selected' : ''} `} onClick={()=>alert("this method in progres unable to use")}>
                            ...
                            <div className={`opacity-25 card align-items-center method ${Paymentmethods.paypal ? 'selected' : ''} `} onClick={()=>alert("this method in progres unable to use")}>
                                <div className='card-body'>
                            ...
                            <div className={`opacity-25 card align-items-center method ${Paymentmethods.momo ? 'selected' : ''} `}  onClick={()=>alert("this method in progres unable to use")}>
                                <div className='card-body'>
                            ...
                            <div className={`opacity-25 card align-items-center method ${Paymentmethods.vnpay ? 'selected' : ''} `}  onClick={()=>alert("this method in progres unable to use")}>
                                <div className='card-body'>
                            ...
                            <div className='row'>
                                ...
                                {Paymentmethods.cash &&
                                    <div className='col-md-12'>
                                        ...
                                        <p>Ban da chon thanh toan bang tien mat </p>
                                        <p>Please confirm</p>
                                        <div className='row'>
                                            <div className='col-md-7'><di
                                        </div>
                                        <img src='https://cdn-icons-png.flaticon.com/512/5663/5663390.png' className='w-25' />
                                    </div>
                                }
