...
function ConfirmBook() {
    ...
    const handleConfirm = () => {
        const dataPost = {
            ...
            services: services,
            total_night:dataBook.total_night,
            room_rate:dataBook.room_rate,
                ...
                <div className='col-md-6 card mx-1'>
                    <div className='row'>
                        ...
                        <div className='d-flex justify-content-between'>
                            ...
                            <div className={`card align-items-center method ${Paymentmethods.cash ? 'selected' : ''} `} onClick={() =>{ handleChangeMethod('cash'); setpaymentMethod("Cash")}}>
                                <div className='card-body'>
